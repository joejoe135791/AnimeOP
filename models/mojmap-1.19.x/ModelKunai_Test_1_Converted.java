...
public class ModelKunai_Test_1_Converted<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "kunai_test_1_converted"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Blade.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.333F, 0.0657F, -0.1F, 0.055F, 0.055F, 0.1F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.15F, 1.25F, 0.0F, 0.0F, 0.0F, -0.7854F));

		PartDefinition cube_r2 = Blade.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 2).addBox(0.306F, -0.2F, 0.0F, 0.1F, 0.4F, 0.1F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4F, 1.6F, -0.1F, 0.0F, 0.0F, 0.3927F));

		PartDefinition cube_r3 = Blade.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 2).addBox(-0.407F, -0.2F, 0.0F, 0.1F, 0.4F, 0.1F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.4F, 1.6F, -0.1F, 0.0F, 0.0F, -0.3927F));

		PartDefinition cube_r4 = Blade
				.addOrReplaceChild("cube_r4",
						CubeListBuilder.create().texOffs(0, 2).addBox(-0.1F, -0.6F, -0.1F, 0.2F, 1.1F, 0.1F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(-0.2F, 2.5F, 0.0F, 0.0F, 0.0F, 0.3927F));

		PartDefinition cube_r5 = Blade
				.addOrReplaceChild("cube_r5",
						CubeListBuilder.create().texOffs(1, 2).addBox(-0.2F, -0.5F, -0.1F, 0.3F, 1.0F, 0.1F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.2F, 2.5F, 0.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition cube_r6 = Blade
				.addOrReplaceChild("cube_r6",
						CubeListBuilder.create().texOffs(0, 2).addBox(0.8F, -0.7F, -0.1F, 0.2F, 1.3F, 0.1F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(-1.1F, 2.0F, 0.0F, 0.0F, 0.0F, 0.3927F));

		PartDefinition cube_r7 = Blade
				.addOrReplaceChild("cube_r7",
						CubeListBuilder.create().texOffs(0, 2).addBox(-1.0F, -0.7F, -0.1F, 0.2F, 1.3F, 0.1F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(1.1F, 2.0F, 0.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition cube_r8 = Blade
				.addOrReplaceChild("cube_r8",
						CubeListBuilder.create().texOffs(1, 2).addBox(-0.51F, -0.51F, -0.1F, 0.83F, 0.83F, 0.1F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 3.0F, 0.0F, 0.0F, 0.0F, 0.7854F));

		PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(0, 2).addBox(
				-8.1F, -4.8F, 7.88F, 0.2F, 1.1F, 0.15F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition Ring_r1 = bone.addOrReplaceChild("Ring_r1",
