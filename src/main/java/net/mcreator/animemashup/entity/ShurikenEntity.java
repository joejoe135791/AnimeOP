...
public class ShurikenEntity extends AbstractArrow implements ItemSupplier {
	public ShurikenEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(AnimemashupModEntities.SHURIKEN.get(), world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(AnimemashupModItems.SHURIKEN.get());
	}
	...
	public static ShurikenEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		ShurikenEntity entityarrow = new ShurikenEntity(AnimemashupModEntities.SHURIKEN.get(), entity, world);
	...
	public static ShurikenEntity shoot(LivingEntity entity, LivingEntity target) {
		ShurikenEntity entityarrow = new ShurikenEntity(AnimemashupModEntities.SHURIKEN.get(), entity, entity.level);
