...
import net.mcreator.animemashup.procedures.KunaiProjectileHitsBlockProcedure;
...
public class KunaiEntity extends AbstractArrow implements ItemSupplier {
	public KunaiEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(AnimemashupModEntities.KUNAI.get(), world);
	}
	...
	public void onHitBlock(BlockHitResult blockHitResult) {
		...
		KunaiProjectileHitsBlockProcedure.execute(this.level, blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ());
	}
	...
	public static KunaiEntity shoot(LivingEntity entity, LivingEntity target) {
		KunaiEntity entityarrow = new KunaiEntity(AnimemashupModEntities.KUNAI.get(), entity, entity.level);
