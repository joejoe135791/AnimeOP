 ...
 *
 */
package net.mcreator.animemashup;
...
@Mod("animemashup")
public class AnimemashupMod {
	public static final Logger LOGGER = LogManager.getLogger(AnimemashupMod.class);
	public static final String MODID = "animemashup";
