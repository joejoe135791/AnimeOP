...
public class HeadbandRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = new ResourceLocation("animemashup", "textures/entities/blueleafheadband_texture.png");
	private final Modelblueleafheadband model;

	public HeadbandRenderer() {
		this.model = new Modelblueleafheadband(Minecraft.getInstance().getEntityModels().bakeLayer(AnimemashupModLayerDefinitions.HEADBAND));
	}
